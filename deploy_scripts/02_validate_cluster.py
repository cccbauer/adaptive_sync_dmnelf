...
# DiFuMo group
difumo_file = Path("/projects/swglab/data/DMNELF/analysis/MNE/jupyter/microstate_pda_v3/data/derivatives/difumo") / (SUBJECT + "_ses-01_task-baseline_run-01_parcels-64.npy")
if difumo_file.exists():
    parcels = np.load(difumo_file)
    ...
    print(f"  DiFuMo PDA: mean={np.mean(pda_difumo):.3f}")
    has_difumo = True
else:
